...
$client = new KClient('https://star-channel.space/', 'fk9FkqmrJxJT2Thy');
    ...
    <div class="container"  style=" background-color:white">
        <div class="row">
            <div class="col-sm">
                ...
                <img src="img/logo_painsboard/index_part2.png" width="500">
            </div>
            <div class="col-sm">
                <br>
                <div class="doc_banner_text_three text-center">
                    ...
                    <p>Ideas are the currency in the current era of the mind.</p>
                    <p>Organizations are always looking for ideas to fuel transformation and innovation. 
                            Surprisingly, problems are great sources of creative ideas. </p>
                    <p>This PainsBoard is a perfect platform 
                            to harvest pain-points to open-up doors of opportunities to create transformational value creations.</p>
                            <a href="signup.php" class="action_btn ">Sign Up Your Organization for <br>Free 30-days Trial</a>
                            <br>
                </div>
