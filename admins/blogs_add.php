        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Add New Entry</p>
                  <div class="row">
                    <div class="col-12">
                    <form class="forms-sample" action="api/add_blog.php" method="post" enctype="multipart/form-data">
