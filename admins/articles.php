        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Article List&nbsp;&nbsp;&nbsp;<a href="article_add.php" class="btn btn-primary">Add new article</a></p>
                  <div class="row">
                    <div class="col-12">
                                                ...
                                                while($row = mysqli_fetch_array($result)){
                                                        ...
                                                        // echo "<td><img src='https://chart.googleapis.com/chart?chs=100x100&cht=qr&chl=" . $row['event_id'] . "&choe=UTF-8'/></td>";
                                                            echo "<td width='15%'>";
                                                                ...
                                                                echo '<a href="api/delete_article.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure to remove '.$row['title'] .'?\')" class="mr-3" title="Delete Article" data-toggle="tooltip"><span class="mdi mdi-delete"></span></a>';
                                                                echo '<a href="article_edit.php?id='.$row['id'].'" class="mr-3" title="Edit Article" data-toggle="tooltip"><span class="mdi mdi-tooltip-edit"></span></a>';
                                                            echo "</td>";
                                                        echo "</tr>";
                                                    }
