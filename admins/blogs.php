        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Blog List&nbsp;&nbsp;&nbsp;<a href="blogs_add.php" class="btn btn-primary">Add new entry</a></p>
                  <div class="row">
                    <div class="col-12">
                                                      ...
                                                      $date=date_create($row['create_date']);
                                                        ...
                                                        // echo "<td><img src='https://chart.googleapis.com/chart?chs=100x100&cht=qr&chl=" . $row['event_id'] . "&choe=UTF-8'/></td>";
                                                            echo "<td>";
                                                                ...
                                                                echo '<a href="api/delete_blog.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure to remove '.$row['title'] .'?\')" class="mr-3" title="Delete Blog" data-toggle="tooltip"><span class="mdi mdi-delete"></span></a>';
                                                                echo '<a href="blogs_edit.php?id='.$row['id'].'" class="mr-3" title="Edit Blog" data-toggle="tooltip"><span class="mdi mdi-tooltip-edit"></span></a>';
                                                            echo "</td>";
                                                        echo "</tr>";
                                                    }
