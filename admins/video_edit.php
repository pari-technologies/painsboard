...
$sql = "SELECT * FROM admin_video where id = '".$id."'";
            if($result = mysqli_query($link, $sql)){
                if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_array($result)){
                        ...
                        $video_source = 'assets/videos/'.$row['video_source'];
        ...
        <div class="content-wrapper">
          <div class="row">
              <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <h3 class="font-weight-bold">Video</h3>
              </div>
          </div>
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Edit Video</p>
                  <div class="row">
                    <div class="col-12">
                    <form class="forms-sample" action="api/edit_video.php" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputName1">Title</label>
                        <input type="hidden" class="form-control" id="video_id" name="video_id" value="<?php echo $id; ?>">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="4" id="description" name="description" placeholder="Description" autocomplete="off" onkeyup="countChar(this)"><?php echo $description; ?></textarea>
                        <div id="charNum" style="float: right;">0</div>
                      </div>
                      <div class="form-group">
