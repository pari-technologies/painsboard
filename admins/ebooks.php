        ...
        <div class="content-wrapper">
          <div class="row">
              <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <h3 class="font-weight-bold">eBooks</h3>
              </div>
          </div>
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">eBooks List&nbsp;&nbsp;&nbsp;<a href="ebook_add.php" class="btn btn-primary">Add new eBook</a></p>
                  <div class="row">
                    <div class="col-12">
                                                ...
                                                while($row = mysqli_fetch_array($result)){
                                                      $date=date_create($row['create_date']);
                                                        ...
                                                        // echo "<td><img src='https://chart.googleapis.com/chart?chs=100x100&cht=qr&chl=" . $row['event_id'] . "&choe=UTF-8'/></td>";
                                                            echo "<td width='15%'>";
                                                                echo '<a href="api/delete_ebook.php?id='.$row['id'].'" onclick="return confirm(\'Are you sure to remove '.$row['title'] .'?\')" class="mr-3" title="Delete eBook" data-toggle="tooltip"><span class="mdi mdi-delete"></span></a>';
                                                                echo '<a href="ebook_edit.php?id='.$row['id'].'" class="mr-3" title="Edit eBook" data-toggle="tooltip"><span class="mdi mdi-tooltip-edit"></span></a>';
                                                            echo "</td>";
                                                        echo "</tr>";
                                                    }
