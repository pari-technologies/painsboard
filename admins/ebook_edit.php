...
$sql = "SELECT * FROM admin_ebook where id = '".$id."'";
            if($result = mysqli_query($link, $sql)){
                if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_array($result)){
                        ...
                        $preview_img = 'assets/preview_img/'.$row['preview_img'];
                        $ebook_source = 'assets/ebooks/'.$row['ebook_source'];
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Edit eBook</p>
                  <div class="row">
                    <div class="col-12">
                    <form class="forms-sample" action="api/edit_ebook.php" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputName1">Title</label>
                        <input type="hidden" class="form-control" id="ebook_id" name="ebook_id" value="<?php echo $id; ?>">
                        <input type="text" class="form-control" id="title" name="title" placeholder="Title" autocomplete="off" value="<?php echo $title; ?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Description</label>
                        <input type="text" class="form-control" id="description" name="description" placeholder="Description" autocomplete="off" value="<?php echo $description; ?>"> 
                      </div>
                      <div class="form-group">
                      ...
                      <div class="input-group col-xs-4">
                            <img class="img-fluid" src="<?php echo $preview_img;?>" alt="" width="30%">
                          </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="file" name="ebook_file" class="file-upload-default" >
                        <div class="input-group col-xs-12">
                          <input type="text" class="form-control file-upload-info" disabled placeholder="Upload eBook file">
                          <span class="input-group-append">
                            <button class="file-upload-browse btn btn-primary" type="button">Upload</button>
                          </span>
                        </div>
                      ...
                      <div class="form-group">
                      <label>Current eBook</label>
                      <div class="input-group col-xs-4">
                        <a href="<?php echo $ebook_source; ?>" target="_blank">Show eBook</a>
                          </div>
                    </div>
