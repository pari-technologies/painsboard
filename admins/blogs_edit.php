        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Edit Blog Entry</p>
                  <div class="row">
                    <div class="col-12">
                    <form class="forms-sample" action="api/edit_blog.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="content" id="content" style="height:300px"><?php echo $content; ?></textarea>
                        <!-- <textarea id="content" name="content"></textarea> -->
                      </div>
                      
                      <button type="submit" class="btn btn-primary mr-2">Submit</button>
                      <a href="blogs.php" class="btn btn-light">Cancel</a>
                    </form>
                    </div>
                  </div>
                  </div>
