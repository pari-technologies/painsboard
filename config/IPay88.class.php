...
class IPay88 {
  ...
  public static $payment_methods = array(
    array(2, 'Credit Card (MYR)', 'MYR'),
    array(6, 'Maybank2U', 'MYR'),
    array(8, 'Alliance Online', 'MYR'),
    array(10, 'AmOnline', 'MYR'),
    array(14, 'RHB Online', 'MYR'),
    array(15, 'Hong Leong Online', 'MYR'),
    array(20, 'CIMB Click', 'MYR'),
    array(22, 'Web Cash', 'MYR'),
    array(31, 'Public Bank Online', 'MYR'),
    array(48, 'PayPal (MYR)', 'MYR'),
    array(55, 'Credit Card (MYR) Pre-Auth', 'MYR'),
    array(102, 'Bank Rakyat Internet Banking', 'MYR'),
    array(103, 'Affin Online', 'MYR'),
    array(124, 'BSN Online', 'MYR'),
    array(134, 'Bank Islam', 'MYR'),
    array(152, 'UOB', 'MYR'),
    array(166, 'Bank Muamalat', 'MYR'),
    array(167, 'OCBC', 'MYR'),
    array(168, 'Standard Chartered Bank', 'MYR'),
    array(198, 'HSBC Online Banking', 'MYR'),
  );
  ...
  public static $referer_url = 'payment.ipay88.com.my'; // without scheme (http/https)
  ...
  private $payment_request = array(
    ...
    'BackendURL'  => '',  // (Optional) BackendURL Payment response page.
  );
