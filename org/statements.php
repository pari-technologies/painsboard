                            ...
                            <table id="example" class="display" style="width:100%">
                                <thead>
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT * from org_statement where org_id = '".$id."' order by id desc";
                                        if($result = mysqli_query($link, $sql)){
                                            if(mysqli_num_rows($result) > 0){
                                                while($row = mysqli_fetch_array($result)){
                                                    list($content) = explode('<img', urldecode($row['content']), 2);
                                                    $str = mb_strimwidth($content,0,500,'...<a href="statements_entry.php?id='.$id.'&sid='.$row['id'].'"><b>See more</b></a>');
                                                        ...
                                                        <div class="post-content">
                                                            ...
                                                            <div class="entry-content">
                                                                ...
                                                                <h3 class="post-title">
                                                                    <a href="statements_entry.php?id='.$id.'&sid='.$row['id'].'">'. $row['title'] .'</a>
                                                                </h3>
                                                                <p>'.$str.'</p>
                                                                <ul class="meta">
                                                                    
                                                                    <li><i class="icon_calendar"></i>'.date("d/m/Y", strtotime($row['create_date'])).'</li>
                                                                </ul>
                                                            </div>
                                                        </div>
