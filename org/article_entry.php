...
$sql2 = "SELECT * FROM org_article where id = '".$sid."'";
                ...
                <div class="row">
                    ...
                    <div class="widget tag_widget">
                            ...
                            <ul class="list-unstyled w_tag_list style-light">
                                <?php
                                $sql_k1 = "SELECT * from org_article where id != '".$sid."'order by id desc limit 5";
                                //echo $sql_k1;
                                if($result_k1 = mysqli_query($link, $sql_k1)){
                                    if(mysqli_num_rows($result_k1) > 0){
                                        while($row_k1 = mysqli_fetch_array($result_k1)){
                                            echo '<li><a href="article_entry.php?id='.$id.'&sid='.$row_k1['id'].'"><h6>'.$row_k1['title'].'</h6></a></li>';
                                        }
                                    }
                                }
                                ?>
