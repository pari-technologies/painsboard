                            ...
                            <div class="scroll">
                                <ul class="list-unstyled nav-sidebar">
                                    ...
                                    <li class="nav-item active">
                                        ...
                                        <ul class="list-unstyled dropdown_nav">
                                            <li><a href="profile_detail.php?id=<?php echo $id;?>" >View Profile</a></li>
                                            <li><a href="profile_picture.php?id=<?php echo $id;?>" class="active">Change Profile Picture</a></li>
                                            <li><a href="profile_password.php?id=<?php echo $id;?>">Change Password</a></li>
                                        </ul>
                                    </li>
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div id="post" class="documentation_info">
                            <article class="documentation_body" id="documentation">
                                ...
                                <form method="post" action="../api/edit_user_picture.php" class="row login_form" enctype="multipart/form-data">
                                    <div class="col-lg-12 form-group">
                                        <div class="small_text">Current Picture</div>
                                        <div class="col-lg-12 form-group">
                                            <?php if($user_picture!=NULL && $user_picture!=""){?>
                                                <img src="<?php echo "data:image/png;base64,".$user_picture;?>" alt="" height="70">
                                            <?php 
                                            }
                                            else{
                                            ?>
                                                <img src="../img/logo_painsboard/user.png" alt="" height="70">
                                            <?php }?>
                                        </div>
                                    </div>
                                    
                                    <div class="col-lg-12 form-group">
                                    <div class="small_text">Profile Picture</div>
                                    <input name="user_id" id="user_id" type="hidden" class="form-control" value="<?php echo $user_id; ?>">
                                    ...
                                    <div class="col-lg-12 text-center">
                                        <button type="submit" class="btn action_btn thm_btn">Change Picture</button>
                                    </div>
