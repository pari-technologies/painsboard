                ...
                <div class="col-lg-2 col-md-2">
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div id="post" class="documentation_info">
                            ...
                            <h4>About&nbsp;</h4>
                            <p>Ideas are the currency in the current era of the mind. Organizations are always looking for
                                ideas to fuel transformation and innovation. Surprisingly, negative feedbacks are great
                                sources of creative ideas.
                            </p>

                            <p>Negative feedbacks are about problems, issues, complaints or pain-points that anyone is
                                facing with regards to your products or services. It could be difficulties that your own
                                internal staff are facing during the manufacturing processes, bad experiences of customers
                                who are using your products or services, complaints from your suppliers and contractors,
                                feedbacks from disgruntled customers who have decided to go for alternative products or
                                services or even worries from non-customers who are interested but are still hesitant to
                                purchase your offerings.
                            </p>

                            <p>This <a href="index.php">www.PainsBoard.com</a> is a perfect platform to harvest these negative feedbacks to
                                open-up doors of opportunities to create transformational value creations.While it might be
                                hurtful at first in seeking these negative feedbacks, you normally end up getting lots of
                                creative ideas that could lead to drastically improving your products or services.
                            </p>

                            <p>By definition, innovation is the process of transforming creative ideas into higher valuable
                                products or services. Hence, getting lots of creative ideas is the very first step that is needed
                                to jump start the innovation process. In other words, without creative ideas, innovation will
                                never happen.
                            </p>

                            <p>These negative feedbacks will be analyzed into Key Pain-Point Indicators (KPPI). KPPI is a
                                much more meaningful and practical indicator compared to the typical Key Performance
                                Indicator (KPI).
                            </p>

                            <p>Data on KPPI provides powerful evidence and input for meaningful strategic planning
                                session for the organization. It facilitates organization to prioritise certain strategies and
                                action plans to be implemented to resolve root causes of identified graved issues.
                            </p>

                            <p>As such, KPPI is a measure of weaknesses of the organization over time. If KPPI keeps
                                decreasing, it is a good sign that the management team is doing something effective to
                                resolve those negative feedbacks.
                            </p>

                            <p>On the other hand, if KPPI keeps increasing, it is not a good sign for the organization.
                            Increasing trend of KPPI means that the management is not doing enough efforts to resolve
                            those pain points.
                            </p>

                            <p>Data on the trending of KPPI shall provide instant feedbacks on the effectiveness of
                            solutions that are implemented to resolve those negative feedbacks.
                            </p>

                            <p>The detail concept on KPPI and its immense contribution in Strategic Transformation Plan 
                                is explained in our book entitled, Break The Pattern – The Science of Transformational 
                                Value Creation (2018). 
                            </p>

                            <p>The book can be purchased from:
                                <ul>
                                    <li>The physical book from <a href="https://www.lazada.com.my/products/break-the-pattern-the-science-of-transformational-value-creation-i222652894-s282869566.html?spm=a2o4k.searchlist.list.2.49a82e699kcvBO&search=1" target="_blank" style="color:blue">here</a> </li>
                                    <li>eBook from <a href="https://www.amazon.com/dp/B07Y2C3ZD2" target="_blank" style="color:blue">here</a> </li>
                                </ul>
                            </p>
