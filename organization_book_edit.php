...
$sql = "SELECT * FROM org_books where id = '".$sid."'";
            if($result = mysqli_query($link, $sql)){
                if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_array($result)){
                        ...
                        $preview_img = 'org/assets/preview_img/'.$row['preview_img'];
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div id="post" class="documentation_info">
                            <article class="documentation_body" id="documentation">
                                <h4>Edit Book</h4>
                                <form method="post" action="api/edit_book.php" class="row login_form" enctype="multipart/form-data">
                                    <div class="col-sm-12 form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title" placeholder="Title" required value="<?php echo $title;?>">
                                    </div>
                                    <div class="col-sm-12 form-group">
                                        <div class="small_text">Description</div>
                                        <input type="text" class="form-control" name="description" id="description" placeholder="Description" required value="<?php echo $description;?>">
                                    </div>
                                    <div class="col-sm-12 form-group">
                                        <div class="small_text">Book Link</div>
                                        <input type="text" class="form-control" name="book_link" id="book_link" placeholder="Book Link" required value="<?php echo $book_link;?>">
                                    </div>
                                    <div class="col-sm-12 form-group">
                                    ...
                                    <div class="col-sm-12 form-group">
                                        <div class="small_text">Current Image</div>
