                ...
                <div class="row">
                            ...
                            <div class="scroll">
                                <ul class="list-unstyled nav-sidebar">
                                    ...
                                    <li class="nav-item active">
                                        ...
                                        <ul class="list-unstyled dropdown_nav">
                                            <li><a href="organization_detail.php?id=<?php echo $id;?>" >View Profile</a></li>
                                            <li><a href="organization_logo.php?id=<?php echo $id;?>" class="active">Change Logo</a></li>
                                            <li><a href="organization_password.php?id=<?php echo $id;?>" >Change Password</a></li>
                                        </ul>
                                    </li>
                                </ul>
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div id="post" class="documentation_info">
                            ...
                            <h4>Change Logo&nbsp;</h4>
                            <form method="post" action="api/edit_org_logo.php" class="row login_form" enctype="multipart/form-data">
                            <div class="col-lg-12 form-group">
                                <div class="small_text">Current Logo</div>
                                <div class="col-lg-12 form-group">
                                <img src="<?php echo "data:image/png;base64,".$org_logo;?>" alt="" height="100">
                                </div>
                            </div>
                            
                            <div class="col-lg-12 form-group">
                            <div class="small_text">Organization Logo</div>
                            ...
                            <div class="col-lg-12 text-center">
                                <button type="submit" class="btn action_btn thm_btn">Change Logo</button>
                            </div>
