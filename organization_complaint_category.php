...
<body data-spy="scroll" data-target="#navbar-example3" data-offset="86" class="full-width-doc sticky-nav-doc doc">
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div id="post" class="documentation_info">
                            <article class="documentation_body" id="documentation">
                                <h4>Concern Category&nbsp;&nbsp;<a style=" color: white" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Add New Category</a></h4>
                            <table id="example" class="display" style="width:100%">
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM complaints_type where org_id = '".$id."'";
                                            ...
                                            if(mysqli_num_rows($result) > 0){
                                                while($row = mysqli_fetch_array($result)){
                                                        ...
                                                        // echo "<td><img src='https://chart.googleapis.com/chart?chs=100x100&cht=qr&chl=" . $row['event_id'] . "&choe=UTF-8'/></td>";
                                                            echo "<td width='20%'>";
                                                                echo '<a href="#" class="mr-3" title="Edit Category" data-toggle="modal" data-target="#editModal" onclick="editComplaintCategory(\''. $row['name'] .'\',\''. $row['id'] .'\')"><span class="fa fa-edit"></span></a>';
                                                                echo '&nbsp;&nbsp;';
                                                                echo '<a href="api/delete_complaint_category.php?id='. $row['id'] .'&org_id='. $id .'" onclick="return confirm(\'Are you sure to remove '.$row['name'] .'?\')" class="mr-3" title="Delete Category" onclick="return confirm(\'Are you sure to delete the category?\')" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                                            echo "</td>";
                                                        echo "</tr>";
                                                    }
    ...
    <div id="myModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <h4 class="modal-title">Add Concern Category</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                
            </div>
            <div class="modal-body">
                    <form method="post" action="api/add_complaint_category.php" class="row login_form">
    ...
    <div id="editModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
            <div class="modal-header">
            <h4 class="modal-title">Edit Concern Category</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                
            </div>
            <div class="modal-body">
                    <form method="post" action="api/edit_complaint_category.php" class="row login_form">
                            <div class="col-lg-12 form-group">
                                <div class="small_text">Category Name</div>
                                <input type="text" class="form-control" id="edit_cat_name" name="edit_cat_name" placeholder="Name">
                                <input type="hidden" class="form-control" id="edit_cat_id" name="edit_cat_id">
                                <input type="hidden" class="form-control" id="org_id" name="org_id" value="<?php echo $id;?>">
                            </div>
    ...
    <script>
        ...
        function editComplaintCategory(cat_name, cat_id) {
