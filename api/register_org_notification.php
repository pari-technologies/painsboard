...
function thankYouNotification($org_name) {
 
   
    //   $to = "helmi.hasman@gmail.com";
      $subject = "PainsBoard - New organization registered";

      $message = $org_name.' has registered with Painsboard.'; 
    ...
    $mail->addAddress("info@painsboard.com");
