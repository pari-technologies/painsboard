...
//    if(isset($_FILES['event_banner']))
    ...
    $i_org_id = $_POST["org_id"];
     ...
     // Attempt select query execution
                    $sql = "INSERT INTO org_video (org_id,title,description,video_source,preview_img) "
                         . "VALUES ('".$i_org_id."','".$i_title."','".$i_description."','".$file_name_video."','".$file_name_preview_img."')";
