...
//    if(isset($_FILES['event_banner']))
        ...
        //    if(isset($_FILES['event_banner']))
                {
                 ...
                 //   $file_name =$_FILES['image']['tmp_name'];
                    ...
                    if(empty($errors))
                    {
                       if( move_uploaded_file($file_tmp, '../org/assets/ebooks/'.$file_name_ebook));
                       {
                        // echo 'File uploaded';
                       }
    ...
    $i_org_id = $_POST["org_id"];
     ...
     // Attempt select query execution
                    $sql = "INSERT INTO org_ebooks (org_id,title,description,ebook_source,preview_img) "
                         . "VALUES ('".$i_org_id."','".$i_title."','".$i_description."','".$file_name_ebook."','".$file_name_preview_img."')";
