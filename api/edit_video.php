...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  //  Attempt select query execution
                  $sql = "UPDATE org_video set title = '".$i_title."', description = '".$i_description."' where id = '".$i_video_id."' ";
                  ...
                  //    if(isset($_FILES['event_banner']))
                          ...
                          //    if(isset($_FILES['event_banner']))
                                  ...
                                  //   $file_name =$_FILES['image']['tmp_name'];
                                      ...
                                      if(empty($errors))
                                      {
                                        if( move_uploaded_file($file_tmp, '../org/assets/videos/'.$file_name_video));
                                        {
                                          // echo 'File uploaded';
                                        }
                      ...
                      if($file_name_preview_img == "" &&  $file_name_video == ""){
                        header("Location: ../organization_videos.php?id=$i_org_id");
                      }
                      else{
                        if($file_name_preview_img != "" ){
                          $sql2 = "UPDATE org_video set preview_img = '".$file_name_preview_img."' where id = '".$i_video_id."' ";
                        ...
                        if($file_name_video != "" ){
                          $sql3 = "UPDATE org_video set video_source = '".$file_name_video."' where id = '".$i_video_id."' ";
