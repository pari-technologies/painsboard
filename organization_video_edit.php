...
$sql = "SELECT * FROM org_video where id = '".$sid."'";
            if($result = mysqli_query($link, $sql)){
                if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_array($result)){
                        ...
                        $video_source = 'org/assets/videos/'.$row['video_source'];
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div id="post" class="documentation_info">
                            <article class="documentation_body" id="documentation">
                                <h4>Edit Video</h4>
                                <form method="post" action="api/edit_video.php" class="row login_form" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-12 form-group">
                                        <div class="small_text">Video</div>
                                        <input type="file" id="video_file" name="video_file" class="form-control">
                                    </div>
                                    <div class="col-sm-12 form-group">
                                        <div class="small_text">Current Video</div>
