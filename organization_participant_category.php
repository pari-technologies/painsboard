...
<body data-spy="scroll" data-target="#navbar-example3" data-offset="86" class="full-width-doc sticky-nav-doc doc">
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div id="post" class="documentation_info">
                            <article class="documentation_body" id="documentation">
                                <h4>Participant Category&nbsp;&nbsp;<a style=" color: white" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Add New Category</a></h4>
                                            ...
                                            if(mysqli_num_rows($result) > 0){
                                                while($row = mysqli_fetch_array($result)){
                                                        ...
                                                        // echo "<td><img src='https://chart.googleapis.com/chart?chs=100x100&cht=qr&chl=" . $row['event_id'] . "&choe=UTF-8'/></td>";
                                                            echo "<td width='20%'>";
                                                                echo '<a href="#" class="mr-3" title="Edit Category" data-toggle="modal" data-target="#editModal" onclick="editUserCategory(\''. $row['name'] .'\',\''. $row['id'] .'\')"><span class="fa fa-edit"></span></a>';
                                                                echo '&nbsp;&nbsp;';
                                                                echo '<a href="api/delete_participant_category.php?id='. $row['id'] .'&org_id='. $id .'" onclick="return confirm(\'Are you sure to remove '.$row['name'] .'?\')" class="mr-3" title="Delete Category" onclick="return confirm(\'Are you sure to delete the category?\')" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                                            echo "</td>";
                                                        echo "</tr>";
                                                    }
    ...
    <div id="editModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
            <div class="modal-header">
            <h4 class="modal-title">Edit Participant Category</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                
            </div>
            <div class="modal-body">
                    <form method="post" action="api/edit_participant_category.php" class="row login_form">
                            <div class="col-lg-12 form-group">
                                <div class="small_text">Category Name</div>
    ...
    <script>
        ...
        function editUserCategory(cat_name, cat_id) {
