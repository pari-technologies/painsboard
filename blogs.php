                                                ...
                                                while($row = mysqli_fetch_array($result)){
                                                        ...
                                                        <div class="post-content">
                                                            ...
                                                            <div class="entry-content">
                                                                ...
                                                                <h3 class="post-title">
                                                                    <a href="blogs_entry.php?id='.$row['id'].'">'. $row['title'] .'</a>
                                                                </h3>
                                                                <p>'.mb_strimwidth(strip_tags(createPreview(urldecode($row['content']))),0,500,'...<a href="blogs_entry.php?id='.$row['id'].'"><b>See more</b></a>').'</p>
                                                                <ul class="meta">
                                                                    
                                                                    <li><i class="icon_calendar"></i>'.date("d/m/Y", strtotime($row['create_date'])).'</li>';
                                                                    $sql2 = "SELECT count(id) as comment_count from blog_comment where blog_id = '".$row['id']."'";
                                                                    //echo $sql2."<br>";
