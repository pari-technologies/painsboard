                    ...
                    <div class="col-lg-9 col-md-9">
                        <div id="post" class="documentation_info">
                            <article class="documentation_body" id="documentation">
                                <h4>eBooks&nbsp;&nbsp;<a href="organization_ebook_add.php?id=<?php echo $id;?>" style=" color: white" class="btn btn-primary" >Add New eBook</a></h4>
                            <table id="example" class="display" style="width:100%">
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM org_ebooks where org_id = $id";
                                            ...
                                            if(mysqli_num_rows($result) > 0){
                                                while($row = mysqli_fetch_array($result)){
                                                        ...
                                                        // echo "<td><img src='https://chart.googleapis.com/chart?chs=100x100&cht=qr&chl=" . $row['event_id'] . "&choe=UTF-8'/></td>";
                                                            echo "<td width='15%'>";
                                                                echo '<a href="api/delete_ebook.php?id='. $row['id'] .'&org_id='. $id .'" onclick="return confirm(\'Are you sure to remove '.$row['title'] .'?\')" class="mr-3" title="Delete eBook" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                                                echo '<a href="organization_ebook_edit.php?sid='. $row['id'] .'&id='. $id .'" class="mr-3" title="Edit eBook" data-toggle="tooltip"><span class="fa fa-edit"></span></a>';
                                                            echo "</td>";
                                                        echo "</tr>";
                                                    }
