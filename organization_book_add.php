                    ...
                    <div class="col-lg-9 col-md-9">
                        <div id="post" class="documentation_info">
                            <article class="documentation_body" id="documentation">
                                <h4>Add New Book</h4>
                                <form method="post" action="api/add_book.php" class="row login_form" enctype="multipart/form-data">
                                    ...
                                    <div class="col-sm-12 form-group">
                                        ...
                                        <input type="text" class="form-control" name="book_link" id="book_link" placeholder="Book Link" required>
                                    </div>
                                    <div class="col-sm-12 form-group">
