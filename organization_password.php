...
<body data-spy="scroll" data-target="#navbar-example3" data-offset="86" class="full-width-doc sticky-nav-doc doc">
                ...
                <div class="row">
                                ...
                                <ul class="list-unstyled nav-sidebar">
                                    ...
                                    <li class="nav-item active">
                                        ...
                                        <ul class="list-unstyled dropdown_nav">
                                            <li><a href="organization_detail.php?id=<?php echo $id;?>" >View Profile</a></li>
                                            <li><a href="organization_logo.php?id=<?php echo $id;?>" >Change Logo</a></li>
                                            <li><a href="organization_password.php?id=<?php echo $id;?>" class="active">Change Password</a></li>
                                        </ul>
                                    </li>
                                </ul>
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div id="post" class="documentation_info">
                            ...
                            <form method="post" action="api/edit_org_password.php" class="row login_form" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-12 form-group">
                                    ...
                                    <div class="confirm_password">
                                        ...
                                        <a class="forget_btn" onclick="current_password_toggle()"><i class="far fa-eye" id="togglePassword" style=" cursor: pointer;"></i></a>
                                    </div>
                                    <!-- <input name="current_password" id="current_password" type="password" class="form-control" placeholder="Current Password" autocomplete="off" required> -->
                                </div>
                                <div class="col-lg-12 form-group">
                                    ...
                                    <div class="confirm_password">
                                        ...
                                        <a class="forget_btn" onclick="new_password_toggle()"><i class="far fa-eye" id="togglePassword" style=" cursor: pointer;"></i></a>
                                    </div>
                                    <!-- <input name="new_password" id="new_password" type="password" class="form-control" placeholder="Password" autocomplete="off" required> -->
                                </div>
                                <div class="col-lg-12 form-group">
                                    ...
                                    <div class="confirm_password">
                                        ...
                                        <a class="forget_btn" onclick="re_password_toggle()"><i class="far fa-eye" id="togglePassword" style=" cursor: pointer;"></i></a>
                                    </div>
                                    <!-- <input name="re_password" id="re_password" type="password" class="form-control" placeholder="Reconfirm Password" autocomplete="off" required> -->
                                </div>
    ...
    <script>
        ...
        function current_password_toggle() {
